...
@Entity
@Table(name = "temp_log_clear_setting")
public class TempLogClearSetting {
    ...
    public TempLogClearSetting() {}

    public TempLogClearSetting(String userId, LocalDateTime clearedAt) {
        this.userId = userId;
